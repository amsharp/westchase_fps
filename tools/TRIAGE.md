...
Status: 6 FIXED@v1.66.58 (qa1-fx slice), rest OPEN.
...
- mrf7rsmq (48,30)    quest NPC stands mid-road under his beacon — IN-AGENT (qa1-world, fable)
- mrf7rss6 (-200,-150) quest beacon points behind backyard fence (unreachable?) — IN-AGENT (qa1-world, fable)
...
- mrf7rtea (310,6)    map edge = flat grey band behind houses — IN-AGENT (qa1-world, fable)
...
- mrf7rtum (-180,-260) tree canopy fills whole screen walking under it — IN-AGENT (qa1-world, fable)
