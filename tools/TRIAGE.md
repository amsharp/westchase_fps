...
- mrf7rril (0,-40)    green hedge box in middle of junction asphalt — IN-AGENT (qa1-fx, fable)
- mrf7rrzk (-104,-22) flame sprite burning on townhouse wall, no source — IN-AGENT (qa1-fx, fable)
- mrf7rs59 (-104,-22) flamingo ornament on bare pavement
- mrf7rsar (40,-40)   giant smeared lane-dash decal near player, others crisp — IN-AGENT (qa1-fx, fable)
...
- mrf7rsy0 (-72,-80)  hedge bar runs down paved walkway w/ fence post inside; wall texture smeary up close — IN-AGENT (qa1-fx, fable)
...
- mrf7rtk5 (60,-8)    rain splashes are floating white squares, not ground rings — IN-AGENT (qa1-fx, fable)
- mrf7rtp6 (150,-85)  crack decal painted on grass; road stretch has no lane markings — IN-AGENT (qa1-fx, fable)
