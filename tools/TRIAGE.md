...
- QUICK FIXES: mrefti0d flowers mid-road — FIXED@v1.66.4 (shrub/grass road-clearance guard at source); mreg8mld post not breakable; mrefrgtb pistol should be one-handed (viewmodel) — IN-AGENT (qa1-props, fable); mreft54h unnatural U-turns at junction — IN-AGENT (qa1-props, fable); mregdctj sign post clipping — IN-AGENT (qa1-props, fable)
...
Status: 6 FIXED@v1.66.58 (qa1-fx slice) + 4 FIXED@v1.66.59 (qa1-world slice), rest OPEN.
...
- mrf7rs59 (-104,-22) flamingo ornament on bare pavement — IN-AGENT (qa1-props, fable)
...
- mrf7rsgx (-40,-40)  cardboard boxes scattered on lot asphalt — IN-AGENT (qa1-props, fable)
