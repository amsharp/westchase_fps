...
- mreexjvh (-178,170) road/tile seam — FIXED@v1.66.17 (ROOT: the road y-ladder ((i*7)%11) gave only 11 height levels for 35+ ribbons, so overlapping roads routinely shared a level and z-fought -> shimmering seam. Here user_e305 (i=33) was coplanar with race_track_rd (i=0). New ladder = class band (arterials on top) + unique per-road micro-offset, so no two ribbons are ever coplanar map-wide.)
- mreexz4c (-163,120) road area bad — FIXED@v1.66.17 (same z-fight-seam ladder fix). RESIDUAL: this spot also has several authored driveways (user_e298/e300/e302) converging with overlapping ribbons + a mid-asphalt dead-end curb cap; that driveway-tangle is a deeper placement issue (would need reworking the authored connectors), left as-is — surgical scope covered the seam.
- mredxzx6 (140,-89) no-road homes — FIXED@v1.66.16 (added res_se_pocket: a cls2 residential street w/ sidewalks branching E off race_track_rd at (121,-94) and running through the SE pocket [[121,-94]..[300,-99]], threading between the north house row (z~-60) and the two 60x35 buildings (241,-135)/(304,-136); junction pad auto-forms at race_track. Route OBB-verified clear of every footprint. Supersedes the round5-structure DEFER.)
- mreenqoe (-25,-347) no-road homes — FIXED@v1.66.16 (added res_s_pocket: a narrow cls3 lane (hw4, no sidewalk to fit the tight ~12u corridor) branching W off nine_eagles_dr at (-8,-339), weaving [[-8,-339]..[-110,-340]] between the z~-327 row and the z~-353/-360 rows of the western cluster. OBB-verified ~1u min clearance. Supersedes the round5-structure DEFER.)
